...
const pluralize = pluralize$1.plural;
const singularize = pluralize$1.singular;
/**
                ...
                if (data[key] !== undefined && data[key] !== null && key in data) {
                    if (isPlainObject(data[key])) {
                        ...
                        if (data[key].nodes && context.connectionMode === ConnectionMode.NODES) {
                            result[pluralize(key)] = this.transformIncomingData(data[key].nodes, localModel, mutation, true);
                        }
                        else if (data[key].edges && context.connectionMode === ConnectionMode.EDGES) {
                            result[pluralize(key)] = this.transformIncomingData(data[key].edges, localModel, mutation, true);
                        }
                            ...
                            result[pluralize(key)] = this.transformIncomingData(data[key].items, localModel, mutation, true);
                        }
                        else {
                            let newKey = key;
